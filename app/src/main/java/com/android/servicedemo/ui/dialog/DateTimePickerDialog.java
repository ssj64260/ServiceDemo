            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btn_confirm:
                        String content;
                        if (mIsTimePicker) {
                            content = tpTime.getCurrentHour() + ":" + tpTime.getCurrentMinute();
                            final Date time = DateTimeUtils.StringToShortTimeIgnoreDate(content);
                            if (time != null) {
                                content = DateTimeUtils.getEnShortTime(time);
                            }
                        } else {
